...
_Buried Signals submission · Investigation: Northwestern lobbying + congressional press corpus, 2022–Q1 2026 · 2026-05-22 · corrections applied 2026-05-25 and 2026-07-09 (see Corrections log at end)_

## Summary

The `data-detective` skill, applied to the GAIN-provided corpus (418K Senate LDA filings, 410K House LDA XML files, 141K Congressional press releases) and augmented with the public FARA bulk dataset and the USAspending.gov DoD contract API, produced **nine findings** worth a reporter's follow-through — four directly from the data-detective detectors (C-001–C-004) and five promoted from the six Spotlight OSINT handoff cycles (C-005–C-009; OS-006 updated C-004). Each is sourced to specific filing UUIDs or House XML filenames via per-record evidence cards in `case/cards/`, and each numeric claim cites the SQL query hash that produced it (see `case/anomalies/*.provenance.json`).
...
| C-002 | "Anchor & Arrow" — a new lobby shop founded by HASC / Sen. Cotton NSA / Navy comptroller staff — has signed 13 AI-defense startups in two years; USAspending.gov confirms $36.0M in DoD contracts to four of those clients (incl. a $22M Air Force SBIR STRATFI to Apex Technology during the representation window). | high | 8 |
...
| C-006 | **Akin Gump's 2025 FARA principals list is 6 sovereigns + Korea Embassy — none of the four C-003/D10 engagements (Ant Group, TP-Link, Adani, United Solar Polysilicon) is FARA-covered at firm OR attorney level.** Akin Gump's current Adani engagement has a client effective date of Nov 21, 2024 — the day after the DOJ EDNY indictment was unsealed (Nov 20, 2024; the LD-1 was posted Dec 31, 2024) — with lobbying targets at the White House + State + Commerce + House on "U.S.-India renewable energy"; DOJ moved to drop the case May 18, 2026, but Judge Garaufis refused immediate dismissal June 26 and Rule 48(a) leave is still pending (as of July 9, 2026). United Solar's chairman Zhang Longgen is former CEO of Daqo and former vice-chair of UFLPA-Entity-Listed Xinjiang Daqo; lobbying targets the Section 232 polysilicon investigation. TP-Link engagement uses Stephen S. Kho — former Acting Chief Counsel for China Enforcement at USTR. Promoted from OS-002 spotlight-handoff. | high | 17 scraped sources + 8 Wayback archives |
| C-007 | **Tarplin, Downs & Young** is the institutional home of two Medicare Part D legislative architects who became drug lobbyists — ProPublica's 2009 investigation named co-founders **Raissa Downs** (HHS Deputy Assistant Secretary for Legislation; Part D implementation) and **Jennifer Young** (HHS Assistant Secretary for Legislation). The firm has carried Amgen/AstraZeneca/BIO/Vertex/BCBS for 16 years. **Vertex Pharmaceuticals (TDY's $6M client) sued HHS-OIG** over the Anti-Kickback Statute interpretation of its Casgevy program — it lost at district court (summary judgment for HHS, March 31, 2025) and its appeal is pending at the D.C. Circuit. TDY was acquired by FGS Global on Sept 10, 2025 (explains the Q4 2025 spending spike D1 flagged). Corrects a D11 name-attribution error: the HHS-leadership position belongs to Downs, not Smith. Promoted from OS-005 spotlight-handoff. | high | 22 scraped sources + Wayback archive |
| C-008 | **Reynolds American — via its subsidiary RAI Services Company, McFaul's $4.4M Ballard Partners client and the contributor of record — paid MAGA Inc. (FEC C00892471) $5M on April 30 2026, its executives lunched with Trump in Jupiter FL May 2, and the FDA issued flavored-vape enforcement-discretion guidance May 8 — within ~10 days.** NYT (Vogel/Jewett) corroborated across 4 independent sources. McFaul is **Managing Partner of Ballard's DC office** + a 2016-17 Trump transition appointments officer for DoD/VA/Armed Services/Intelligence + on Matt Gaetz's transition. Ballard's lobbying revenue went $19.6M → $88.3M (#1 firm 2025); Susie Wiles (WH COS) and Pam Bondi (AG) are Ballard alumni. Promoted from OS-003 spotlight-handoff. | high | NYT primary + 4 secondary + 22 scraped sources |
| C-009 | **Anthony "Lazer" Lazarski (Cornerstone Government Affairs)** — 25-year USAF Colonel + former SASC professional staff + former Sen. Inhofe senior advisor — lobbies for **Boeing, General Dynamics, Anduril, AND Apollo portfolio company Arconic Corp** (OpenSecrets rolls Arconic up to "Apollo Global Management"; Lazarski has no LDA filing for Apollo itself). Sen. Elizabeth Warren (current SASC) attacks on two axes: (a) co-signed 2024 Senate letter naming Apollo for "shadowy" Steward role, (b) campaign platform "Reduce Corporate Influence at the Pentagon" describes his pattern verbatim. **Extends C-004 at one corporate remove**: Brownstein/Sullivan lobby Apollo directly on the Sen Finance axis; Cornerstone/Lazarski lobby an Apollo portfolio company on the Sen Armed Services axis; Warren attacks from both committee positions. Promoted from OS-004 spotlight-handoff. | high | OpenSecrets + Cornerstone bio + 27 scraped sources |

All nine findings are independently verifiable in <5 minutes by an editor: every claim links to the live `lda.senate.gov` document URL and to external corroboration (entity website, USAspending API, OpenSecrets revolving-door page, LinkedIn biographies, Chambers USA recognition).
...
|---|---|---|
| **John Noonan** (EVP, Public Policy at Anchor and Arrow Strategies 2024–2025; President, Anchor & Arrow LLC from Jan 2026) | "Professional Staff Member, House Armed Services Committee; National Security Advisor, Senator Tom Cotton" | [The Hill (2024-05)](https://thehill.com/lobbying/4590681-bottom-line-former-republican-chief-signs-on-to-guard-nutrition-programs/); [Polaris National Security](https://polaris-us.org/team/john-noonan/); [Legistorm](https://www.legistorm.com/person/bio/169217/John_O_Dwyer_Noonan.html) |
| **Christopher Zumbar** | "Congressional Appropriations Liaison, Secretary of the Navy, Office of Financial Management and Comptroller; Defense Fellow, Rep. Betty McCollum; Deputy Commandant, Programs & Resources, Headquarters Marine Corps Comptroller" | [HQMC Navy-OLA-Liaison roster](https://www.hqmc.marines.mil/Agencies/Office-of-Legislative-Affairs/Navy-OLA-Liaison/) — official primary source lists "Marine Corps Appropriations Liaison (FMBE) Major Christopher Zumbar" with @us.navy.mil email (local archive: `case-trace/data-detective/external/factcheck/hqmc-zumbar-marine-comptroller-20260522.md`); [LinkedIn](https://www.linkedin.com/in/christopher-zumbar-a721a256) — login-walled but indexable |
...
**How we found it.** Detector **D8 (`new_registrant_surge`, SQL hash `e51ec9c1d23d4479`)** flagged Anchor & Arrow LLC as a new 2026-Q1 registrant with an unusually large client roster (11 clients in its first quarter). A direct drill-down identified its earlier 2024–2025 incarnation, Anchor & Arrow Strategies, then a single ad-hoc query against `senate_activity_lobbyists` surfaced the founders' covered_position text. Public web searches corroborated the founders' biographies. Note the two entities are **distinct LDA registrants** — Anchor & Arrow Strategies (Austin TX, Senate registrant ID 401108172; the 2024–2025 filings) and Anchor & Arrow LLC (Washington DC, Senate registrant ID 401110145; the 2026 filings) — so filing UUIDs must not be attributed across them.
...
|---|---|---|---|
| Apex Technology, Inc. | **$25,699,922** | **$22M SBIR Phase II STRATFI — multi-mission satellites for low-orbit defense (Air Force), Award FA880925CB005** | Apex Technology represented by Anchor and Arrow Strategies during 2025 (per LegiStorm); STRATFI selection announced as part of the PY24.2 SpaceWERX cohort. First-LD-1-effective-date for the Apex engagement was not separately re-verified against award action date in this cycle; the "lobbying-firm represents client + client receives DoD contract during representation window" pattern stands, but no causal claim is asserted. |
...
Total DoD contract flow to Anchor & Arrow's lobbied clients during the lobbying window: **$36,034,820** against ~$2.4M of disclosed lobbying spend by Anchor & Arrow. *(Correction 2026-07-09: a previous version stated $35,937,820 — an arithmetic error; the four line items above were individually re-verified against the USAspending API and sum to $36,034,820.)* Apex Technology is the cleanest single pairing — ~$100K lobbying retainer with Anchor and Arrow Strategies during 2025; $22M+ Air Force STRATFI contract (FA880925CB005) awarded as part of the PY24.2 SpaceWERX cohort. **No causal claim is made.** Lobbying-firm-represents-client + client-receives-DoD-contract is a structural pattern; SBIR/STRATFI selections run on multi-year competitive cycles and may pre-date the LDA-registration window. The story is the cluster, not a single sequence.

USAspending did **not** return contracts for Palantir, Saronic Technologies, Epirus, CX2, American Phalanx, or Oklo at the 2026-05-22 pull. These likely have contracts under variant recipient names (Palantir's federal subsidiary is "Palantir USG, Inc.") or under classified award streams that USAspending does not capture; a fuzzy-name UEI lookup is a future-cycle improvement.

**Post-publication update (2026-07-09, live USAspending re-query).** The table above reflects the 2026-05-22 vintage. Since then: Overland AI's DoD total has grown to **$10,860,733** across 8 awards (a new $1,999,989 Army SBIR Phase II D2P award, `W5170126CA063`, started 2026-04-15); and Saronic is no longer literally zero — a **$500 Missile Defense Agency "SHIELD" initial order** (`HQ085926FE712`, under the Dec-2025 IDV `HQ085926DF529`) now appears, so the Saronic statement should read "no *material* DoD prime-contract obligations." The structural pattern is unchanged.

**Evidence**

| # | Source | ID / URL | Why it supports the claim |
|---|---|---|---|
| 1 | Senate LDA filing (Saronic Q3 2025) | `1678194c-8051-43bc-a726-2c98ab982ffa` ([live](https://lda.senate.gov/filings/public/filing/1678194c-8051-43bc-a726-2c98ab982ffa/print/)) | Anchor and Arrow Strategies as registrant for Saronic Technologies, Inc. (Q3 2025, $60K, issue DEF, targets incl. Dept. of the Navy); lobbyists Noonan + Jensen. *(Correction 2026-07-09: a previous version dated this filing Q1 2025 and said it listed Zumbar's covered position — it does not; see row 1b.)* |
| 1b | Senate LDA filing (Saronic registration, Q1 2026) | `c40dbd0d-892e-4045-ae97-a3c295b6eb0c` ([live](https://lda.senate.gov/filings/public/filing/c40dbd0d-892e-4045-ae97-a3c295b6eb0c/print/)) | Anchor & Arrow LLC registration for Saronic; lists Zumbar's covered positions verbatim: "Congressional Appropriations Liaison, Secretary of the Navy, Office of Financial Management and Comptroller; Defense Fellow, Rep. Betty McCollum; Deputy Commandant, Programs & Resources, Headquarters Marine Corps Comptroller" |
| 2 | Senate LDA filing (Palantir Q2 2025) | `b0c3c784-2372-46b6-9de6-3f13bb3048b7` ([live](https://lda.senate.gov/filings/public/filing/b0c3c784-2372-46b6-9de6-3f13bb3048b7/print/)) | Palantir Technologies, Inc. engagement (House ID 563590003) with HASC-staffer lobbyist Noonan (quarter label corrected 2026-07-09) |
| 3 | Senate LDA filing (Epirus Q1 2026) | `cfe1ab3f-9eee-45ec-a0cc-a92ea766c308` ([live](https://lda.senate.gov/filings/public/filing/cfe1ab3f-9eee-45ec-a0cc-a92ea766c308/print/)) | Counter-drone weapons company Epirus, Inc. (House ID 773810001), Anchor & Arrow LLC registrant |
| 4 | External: The Hill | https://thehill.com/lobbying/4590681-bottom-line-former-republican-chief-signs-on-to-guard-nutrition-programs/ | Independent confirmation of Noonan's HASC/Cotton background |
...
- **Post-publication update from OS-006 spotlight-handoff (May 22, 2026, three weeks after Warren's May 4 announcement at Capitol Tax Partners):** Apollo Global Management has stayed with Russell Sullivan at Brownstein Hyatt. The Senate LDA database shows zero filings of any kind in which Capitol Tax Partners appears as registrant for Apollo. The Brownstein-Apollo engagement remains intact at $260K/quarter; the BHFS Q1 2026 filing (posted April 17, 2026) lists Sullivan as the lead tax-issue lobbyist with Harold Hancock. The Q2 2026 LDA filing deadline (July 20, 2026) is the definitive test of whether Apollo will migrate.
- **Post-publication update (July 9, 2026):** the migration question is now partly answered — **Apollo followed Warren.** A new Capitol Tax Partners LD-1 for Apollo Global Management (`9fb96e9d-4117-4257-9b6b-3bdfc66d16cf`), **effective June 29, 2026**, signed by Mark Warren July 1, 2026, lists **Warren as the sole lobbyist** (issues: insurance, corporate and international tax). The client demonstrably followed the revolving-door hire within ~8 weeks of his move — converting this monitoring target into a documented fact and strengthening the finding. Whether Apollo *also* keeps Brownstein shows in the Q2 2026 activity reports (due July 20, 2026).

---

## C-005 — The FEC has reclassified Clement's $50M filing as "False and Fictitious"

**Novelty.** The April 28, 2026 FEC warning letter and the reclassification of Clement's $50.25M loan into the "False and Fictitious Filings" repository were first reported publicly by OpenSecrets on **May 15, 2026** (with Quinnipiac Prof. John Martin quoted on the record characterizing the filing as "either typo or fabrication"). The novel contribution of this finding is the **cross-database institutional pattern** — that the same operator (Clement) using two different federal filing systems (LDA and FEC) produced fictitious-filing outcomes flagged by two different federal regulators, and that **Rico Cortez Dukes** (the second sovereign-citizen-pattern LDA filer identified by D9) has an independently documented federal-court litigation history of his own.

**Claim.** The Federal Election Commission has formally taken regulatory action against Christina Loren Clement's Senate campaign committee on the same fictitious-filing pattern data-detective surfaced from the LDA database. On **April 28, 2026, the FEC issued a warning letter** — formally an RFAI (Request for Additional Information) citing 18 U.S.C. § 1001 and threatening removal to the "unverified filings database" — to her committee (STATE OF LOC NATION FOR CLEMENT FOR SENATE, FEC ID **C00857128**) over her **$50.25 million reported self-loan**; the FEC subsequently removed the loan entry from its searchable database, with an FEC spokesperson (Myles Martin, quoted by OpenSecrets) citing the **"False and Fictitious Filings"** section. The "loan" is not cash — Clement's own published policy states the $50.25M is the asserted fair-market value of a license to her self-issued **"Loc Nation Dollar" (LND) currency pegged at 1 LND = $750 USD**. The pattern is not unique to Clement: **Rico Cortez Dukes** (b. 1979, Shreveport LA), the operator of the second sovereign-citizen-pattern LDA filing data-detective surfaced (THEYFEARTRUTH FEDERAL GOVERNMENT OF AMERICA), has a documented federal-court litigation history of **at least eleven pro se complaints** in the U.S. District Court for the Northern District of Texas (2017-2021), including textbook sovereign-citizen-style titles: **"Dukes v. Roman Empire" (3:17-cv-02834), "Dukes v. Federal Reserve Central Bank" (3:17-cv-02510), and "Dukes v. Trump" (3:17-cv-02167)**. Both Clement and Dukes are formally registered FEC 2024 presidential candidates of self-styled sovereign-government parties (Clement: FEC P40016412 REPUBLICAN PARTY; Dukes: FEC P00011163 AMERICAN INDEPENDENT PARTY, statement of candidacy filed 08/17/2021; THEYFEARTRUTH PRESIDENTIAL COMMITTEE FEC ID C00884064).
...
| 2 | FEC candidate page (Clement, Senate Georgia 2026) | [S6GA00366](https://www.fec.gov/data/candidate/S6GA00366/) | Confirms Clement as registered FEC candidate for U.S. Senate Georgia 2026 (REPUBLICAN PARTY, write-in; not on the printed primary ballot per OpenSecrets reporting) |
...
**Post-publication updates (July 9, 2026).** The committee filed an **F99 response on May 5, 2026** defending the loan as an intellectual-property-license valuation ("LND" currency) — the RFAI response deadline was June 2, 2026. A supporting oddity surfaced on re-verification: the "Q2 2025" $20M LDA income report was *posted April 6, 2025* (six days into the quarter it purports to cover) and the Q4 2025 report on October 1 (day one of Q4) — round-number income reported before the quarter elapsed, consistent with the fictitious-filing thesis. (Docket-text precision: the party the report glosses as "ICJ Registrar" appears on the CLEMENT v. GARLAND docket literally as "REGISTRAR PEACE PALACE CARNEGIE PLEINZ.")

---

## C-006 — Akin Gump's FARA-gap is real and at least one engagement looks like it should not be a gap

**Claim.** Akin Gump Strauss Hauer & Feld's complete 2025 FARA foreign-principal list is six sovereigns (UAE, Cambodia, Japan, Palau, Marshall Islands, and Costa Rica — the latter technically via PROCOMER, Costa Rica's state export-promotion agency) plus the Korea Embassy (Exhibit A/B received by DOJ NSD-FARA March 3, 2026). **None of the four engagements C-003/D10 surfaced — Ant Group Co. (CN), TP-Link Systems (SG/VG/GB), Adani North America (IN), United Solar Polysilicon (CN/OM) — is covered at firm OR attorney level FARA.** The same partners (Pomper, Babin, Ros-Lehtinen, Kho) handle both sides but FARA-register only the government clients.
...
- Akin Gump's current Adani engagement has a **client effective date of November 21, 2024 — the day after** the DOJ Eastern District of New York indictment of Gautam Adani (Adani Group chairman) and Sagar Adani was **unsealed** on November 20, 2024 (the indictment was returned under seal October 24, 2024; the LD-1 was *posted* December 31, 2024). The Q4 2024 LD-2 (filing UUID `eef6a92b-3ac6-4e47-84a4-faf0618bcb5a`, signed by Brian Pomper 1/21/2025) reports $20,000 of income for Q4 2024. *(Correction 2026-07-09: the 2026-05-25 revision said "registered December 31, 2024 — six weeks after," reading the LD-1 posting date; the filing's own effective-date field, re-pulled from the LDA API, is 2024-11-21. The original "day after" framing was substantively right — it is now grounded in the filing record rather than asserted.)*
- The lobbying targets are **White House + State Department + Commerce Department + the House of Representatives** — executive-branch-heavy but not executive-only as an earlier version stated.
- Every subsequent quarterly report (Q1 2025 through Q1 2026) is a **no-activity ("Y") filing** — the $20K Q4 2024 quarter is the only reported activity, making this a one-quarter but precisely timed retainer.
...
- New York Times reporting on May 18, 2026 ([`/2026/05/18/nyregion/gautam-adani-indictment-trump.html`](https://www.nytimes.com/2026/05/18/nyregion/gautam-adani-indictment-trump.html); follow-up to the original May 14, 2026 scoop at `/2026/05/14/nyregion/gautam-adani-billionaire-doj-trump.html`) indicates the DOJ is moving to drop the criminal case. **Update (July 9, 2026): the case is not yet dismissed** — Judge Nicholas Garaufis declined immediate dismissal on June 26, 2026, calling the government's motion "terse, bland and conclusory" and ordering prosecutors to justify dropping the case (Reuters, June 26); Rule 48(a) leave of court is still pending as of this update.

This is the configuration most likely to attract NSD-FARA Unit scrutiny: a foreign principal under criminal indictment + executive-branch-heavy lobbying on bilateral state policy + a retainer effective the day after the indictment was unsealed.
...
- The lobbyist is **Stephen S. Kho — former Acting Chief Counsel for China Enforcement at USTR**.
...
- Q1 2025 LD-2 reports $90K income but the rendered LDA print shows empty issue text — likely a rendering artifact; LD-1 retrieval would confirm the topic and counsel. **Update (July 9, 2026):** Akin Gump's Ant Group quarterly reports in the re-sampled quarters are **no-activity ("Y") filings**, while co-registrant Rich Feuer Anderson filed the active reports — the $90K figure needs an LD-1/LD-2 re-pull before publication. New lead from the same query: **Brownstein Hyatt also registered for Ant Group in 2025.**
...
**Possible legal-violation flag.** Federal FARA enforcement (**22 U.S.C. § 611 et seq.**) is theoretically triggered when an agent represents a foreign principal's interests in influencing US government policy. The Adani retainer effective the day after the indictment was unsealed + executive-branch-heavy lobbying + named indicted foreign parent is the configuration most likely to attract NSD-FARA Unit scrutiny. Flagged to the evaluation panel without adjudicating intent.

---

## C-007 — Tarplin, Downs & Young: Medicare Part D architects → drug lobbyists; Vertex v. HHS-OIG lost below, appeal pending

**Novelty.** The 2009 architecture-to-lobbyist transition of Downs and Young was reported by **ProPublica in October 2009** (Olga Pierce, Jeff Larson and Sabrina Shankman, "Medicare Drug Plan Architects Now Drug Company Lobbyists," [`/article/medicare-drug-plan-architects-now-drug-company-lobbyists-102009`](https://www.propublica.org/article/medicare-drug-plan-architects-now-drug-company-lobbyists-102009)); the Vertex v. HHS-OIG Casgevy litigation was reported by **Law360 on July 16, 2024**; the FGS Global acquisition of TDY was publicly announced on **September 10, 2025**. None of these facts are novel individually. The novel contribution of this finding is the **16-year continuity** — that TDY's pharma client roster (Amgen, AstraZeneca, BIO, Boston Scientific, Genzyme/Sanofi, PhRMA, Vertex, BCBS) is largely unchanged from ProPublica's 2009 list, and that one of those clients (Vertex) took the agency (HHS-OIG) — where two of the three TDY founders ran the Office of the Assistant Secretary for Legislation — **to federal court, lost at the district level, and is pressing the appeal**. This finding also **corrects a methodological error** in D11 (the LDA `covered_position` aggregator misattributed the HHS-leadership history to "Pamela Smith"; the actual holder is Raissa Downs).

**Claim.** TDY's two co-founders **Raissa Downs** (HHS Deputy Assistant Secretary for Legislation per ProPublica's text; helped spearhead Medicare Part D implementation — *correction 2026-07-09: an earlier version said "Principal Deputy," a word ProPublica does not use*) and **Jennifer Young** (HHS Assistant Secretary for Legislation; Senior Counselor to HHS Secretary Mike Leavitt) were named by **ProPublica's 2009 investigation "Medicare Drug Plan Architects Now Drug Company Lobbyists"** as Part D architects who became drug-industry lobbyists. Sixteen years later, TDY still carries Amgen, AstraZeneca, BIO, Boston Scientific, Genzyme (Sanofi), PhRMA, Vertex Pharmaceuticals, and Blue Cross Blue Shield. **TDY's $6M+ client Vertex Pharmaceuticals sued HHS-OIG** to set aside the agency's Anti-Kickback Statute interpretation of its Casgevy fertility-preservation program (Vertex Pharmaceuticals v. HHS-OIG, Case 1:24-cv-02046, D.D.C., filed July 15, 2024; Law360 July 16, 2024 coverage quotes Bass Berry & Sims's Jennifer Michael as a third-party expert commentator, not Vertex's counsel). **Litigation status (verified July 9, 2026): Vertex lost — Judge Boasberg granted HHS summary judgment March 31, 2025 (case terminated at district level); Vertex appealed April 21, 2025, and D.C. Circuit No. 25-5133 was argued February 23, 2026 with no decision yet.** *(Correction 2026-07-09: earlier versions described the case as "active federal litigation" without noting the district-court loss, which predated this report by nearly 14 months.)* The litigation puts a top-five TDY client directly against the federal agency where two of three TDY founders ran the Office of the Assistant Secretary for Legislation. TDY was acquired by FGS Global on September 10, 2025 — a market-structure event that explains the Q4 2025 spending spike data-detective's D1 detector flagged.
...
## C-008 — Reynolds-MAGA-FDA timeline: a $5M donation, a Jupiter golf-club lunch, vape guidance eased in 10 days

**Novelty.** The Reynolds → MAGA Inc. donation → Jupiter meeting → FDA flavored-vape reversal timeline was reported by the **New York Times (Kenneth P. Vogel and Christina Jewett, "A $5 Million Donation From Big Tobacco Preceded F.D.A. Vape Decision," May 20, 2026, [`/2026/05/20/us/politics/donation-big-tobacco-vaping.html`](https://www.nytimes.com/2026/05/20/us/politics/donation-big-tobacco-vaping.html))** and is therefore **not a novel disclosure of facts**. The novel contribution of this finding is the **LDA-corpus side of the chain** — that the lobbyist of record on Reynolds American's RAI Services LDA filings is **Daniel McFaul, Managing Partner of Ballard Partners' DC office and a 2016–17 Trump Presidential Transition appointments officer (DoD/VA/Armed Services/Intelligence) and Matt Gaetz transition team member** — connecting the public NYT narrative to a specific lobbyist's institutional history, his $33K of personal FEC giving (46 contributions, 2017–2026, all Republican), and Ballard Partners' broader $19.6M→$88.3M revenue surge that made it the #1 lobbying firm in America in 2025.

**Claim.** **On April 30, 2026, Reynolds American — via its subsidiary RAI Services Company, the contributor of record and the $4.42M cumulative lobbying client of Ballard Partners' Daniel McFaul — paid MAGA Inc. (FEC committee C00892471) $5 million. Two days later (May 2), a top Reynolds executive and two lobbyists lunched with Donald Trump at his golf club in Jupiter, Florida. On May 8 — within ten days — the FDA issued enforcement-discretion guidance easing its flavored-vape stance.** The New York Times's **Kenneth P. Vogel and Christina Jewett reported the timeline, corroborated across four independent secondary sources**. *(Corrections 2026-07-09: an earlier version cited FEC committee C00825851 ("Make America Great Again Inc.") — that super PAC is terminated per openFEC (`filing_frequency: "T"`, last filing May 8, 2025) and has zero 2026 receipts; the verified $5M receipt of 2026-04-30 sits under C00892471 ("MAGA INC.", hybrid PAC), contributor of record RAI SERVICES COMPANY, Winston-Salem NC. RAI's prior $1M receipts (2/5/2025, 6/30/2025, 12/29/2025) bring its total to $8M, matching NYT. The lobbying-fee figure was also updated from $3.18M (a through-2023 tally) to the deduped Senate LDA cumulative of $4.42M through Q1 2026.)*
...
**Confidence:** verified high. NYT primary + 4 corroborating secondary sources + FEC C00892471 receipt record (openFEC) + Ballard firm bio + LegiStorm McFaul biography + OpenSecrets/Politico Ballard revenue. Wayback archives for the primary sources.

**Post-publication updates (July 9, 2026).** June 4, 2026: Sens. Durbin, Warren, Markey, Merkley, Blumenthal and Reed sent letters to Reynolds American and Altria over the "suspicious timeline" (responses requested by July 2); May 20: Durbin letter to HHS Secretary Kennedy urging pushback; June 11: KFF Health News reported Trump grew his tobacco stock holdings amid the industry donations, and that resistance to the flavored-vape moves "reportedly contributed to the ouster of agency commissioner Marty Makary" (mid-May per NYT). No corrections to the NYT story found.

---

## C-009 — Apollo lobbied from both sides of the Senate via Cornerstone's Lazarski; Warren attacks the pattern in writing

**Claim.** **Anthony "Lazer" Lazarski** — a 25-year USAF Colonel; former Senate Armed Services Committee Professional Staff Member; former Senior Legislative Advisor to SASC Chair Jim Inhofe — is the named lobbyist on **Cornerstone Government Affairs**'s 2024 contracts with **Boeing, General Dynamics, Anduril, AND Arconic Corporation — an Apollo Global Management portfolio company (Apollo-owned since 2023)**. *(Correction 2026-07-09: an earlier version said he lobbies for "Apollo Global Management" directly. Live LDA re-verification shows Lazarski has never appeared on a Senate LDA filing for client "Apollo Global Management" in any year; the attribution came from OpenSecrets' parent-company rollup of Cornerstone's four 2024 Arconic filings. Cornerstone has never registered for Apollo itself. Boeing (1 filing), General Dynamics (2), and Anduril (4) are direct.)*
...
**Triangulation with C-004 — at one corporate remove.** Apollo Global Management's interests are lobbied along **two committee axes by former senior committee staff**: Brownstein Hyatt's Sullivan lobbies **Apollo directly** on the Senate Finance axis, while Cornerstone's Lazarski lobbies **Apollo portfolio company Arconic** on the Senate Armed Services axis. **The same senator — Warren — attacks Apollo from both committee positions.** The triangulation is real but weaker than an earlier version stated: the SASC-side client is a portfolio company, not Apollo itself (see correction above).
...
- **Anomaly detectors run:** D1–D12 (see `case/anomalies/*.csv` with companion `*.provenance.json` SHA-tagged audits; D12 `committee_say_vs_pay` is the Congress.gov committee-graph join used in C-004).
...
- **Cycles:** Five execution cycles (per `evidence-map.json` `cycles_completed`). The corpus-efficient design of the skill meant the LLM never had to scan raw records during exploration; cycle 4 added cross-corpus joins (USAspending, D9/D10) and multi-hop SQL (D11), and cycle 5 added the Congress.gov committee join (D12) and the adversarial fact-check — without expanding LLM cost.
...
- **C-005 (Clement/FEC):** The FEC has acted (RFAI + reclassification). Potential onward exposure: 18 U.S.C. § 1001 referral and LDA enforcement (2 U.S.C. § 1605). No determination of intent is made.
- **C-006 (Akin Gump/Adani):** FARA (22 U.S.C. § 611 et seq.) is the relevant regime; whether the §3(d)/§3(h) exemptions legitimately cover each engagement is flagged, not adjudicated.
- **C-007 (TDY/Vertex):** No violation indicated; the litigation and revolving-door pattern are lawful but newsworthy.
- **C-008 (Reynolds/MAGA Inc.):** FECA pay-to-play, 18 U.S.C. § 201, and LDA misreporting are potentially implicated by the timeline; intent and any exchange element are not in the public record. Flagged without adjudicating.
- **C-009 (Cornerstone/Lazarski):** No violation indicated; structural revolving-door pattern, at one corporate remove on the Apollo axis.

---

## Corrections log

**2026-05-25 pass** (see `interaction-traces/02-verification-and-corrections-20260525.jsonl`): eight P5 citation drifts corrected — two wrong C-002 UUIDs, one hallucinated NYT URL path, the Ant Group UUID (`3a6e17c0-…` → `a4411100-…`), the Adani "day after" framing softened, the Bass Berry counsel misattribution, the Noonan title, and the D11 "Pamela Smith" → Raissa Downs attribution.

**2026-07-09 pass** (five parallel fact-check agents against live primary sources; ~45 claims re-checked, all nine findings stand on substance):

| # | Finding | Was | Now | Verified against |
|---|---|---|---|---|
| 1 | C-009 | "lobbies for Apollo, Boeing, General Dynamics, and Anduril" | Apollo link is **indirect**: client is Apollo portfolio company Arconic Corp (OpenSecrets parent rollup); no Lazarski↔Apollo LDA filing exists in any year | Senate LDA API (client=Arconic, registrant=Cornerstone); OpenSecrets lobbyist profile Y0000053591L |
| 2 | C-007 | "Vertex is in active federal litigation against HHS-OIG" | Vertex **lost** at district court (summary judgment for HHS, Boasberg, 3/31/2025); appeal pending, D.C. Cir. No. 25-5133, argued 2/23/2026 | CourtListener docket 68943688 |
| 3 | C-008 | $5M paid to "Make America Great Again Inc. (FEC C00825851)" | Committee is **MAGA INC. (C00892471)**; C00825851 terminated 5/2025. Contributor of record: RAI Services Company | openFEC schedule_a + committee records |
| 4 | C-006 | "registered with the LDA on December 31, 2024 — six weeks after the indictment" | Client **effective date 2024-11-21 — the day after the indictment was unsealed**; 12/31 was the LD-1 posting date. (The 5/25 pass over-corrected; the original "day after" was substantively right, now grounded in the filing record.) | LDA API filing eef6a92b (effective-date field) |
| 5 | C-002 | Evidence row 1: filing `1678194c` "lists Zumbar's covered position" (dated Q1 2025) | That filing (Q3 2025) lists only Noonan + Jensen; Zumbar's covered position is on registration `c40dbd0d` (Q1 2026) | LDA print pages, both UUIDs |
| 6 | C-002 | DoD total "$35,937,820" | **$36,034,820** (arithmetic; line items re-verified individually) | USAspending API |
| 7 | C-007 | Downs "HHS **Principal** Deputy Asst Sec for Legislation"; ProPublica byline "Olga Pierce" | "Deputy Assistant Secretary for Legislation" per ProPublica's text; byline Pierce, Larson and Shankman | ProPublica article text |
| 8 | C-008 | "Christine Jewett"; RAI fees "$3.18M" | **Christina** Jewett; **$4.42M** deduped through Q1 2026 | NYT byline; Senate LDA API |
| 9 | Summary/methodology | "four findings"; "detectors D1–D11"; "two execution cycles" | nine findings; D1–D12; five cycles | internal consistency vs. evidence-map.json + report body |
| 10 | C-004 | "Apollo stayed with Sullivan at Brownstein" (accurate 5/22) | **Apollo followed Warren to Capitol Tax Partners** — LD-1 `9fb96e9d`, effective 6/29/2026, Warren sole lobbyist | Senate LDA API |

Dated post-publication updates (not corrections) were added to C-002 (USAspending staleness), C-005 (F99 response; posting-date oddity), C-006 (Rule 48(a) dismissal still pending before Judge Garaufis), and C-008 (June 2026 congressional letters; KFF reporting). Ground-truth captures for every corrected citation are under `case-trace/data-detective/external/factcheck/*-20260709.md`.
